            ...
            <div class="row">
                ...
                <div class="col-xl-3 col-md-6">
                    <div class="card bg-c-green update-card">
                        ...
                        <div class="card-footer">
                            <p class="text-white m-b-0"><i class="feather icon-users text-white f-14 m-r-10"></i>Jumlah Siswa Aktif</p>
                        </div>
                    </div>
                </div>
                <div class="col-xl-3 col-md-6">
                    <div class="card bg-c-pink update-card">
                        <div class="card-block">
                            <div class="row align-items-end">
                                <div class="col-8">
                                    ...
                                    <h6 class="text-white m-b-0">Guru</h6>
                                </div>
                                <div class="col-4 text-right">
                        ...
                        <div class="card-footer">
                            <p class="text-white m-b-0"><i class="feather icon-user text-white f-14 m-r-10"></i>Jumlah Guru Aktif</p>
                        </div>
                    </div>
                </div>
                <div class="col-xl-3 col-md-6">
                    <div class="card bg-c-lite-green update-card">
                        ...
                        <div class="card-footer">
                            <p class="text-white m-b-0"><i class="feather icon-server text-white f-14 m-r-10"></i>Kelas semester ini</p>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="card-block">
                            <div class="row m-b-25">
                                <div class="col-auto p-r-0">
                                    <div class="u-img">
                                        <img src="{{ asset('adminty\files\assets\images\breadcrumb-bg.jpg') }}" alt="user image" class="img-radius cover-img">
                                        <img src="{{ asset('adminty\files\assets\images\avatar-2.jpg') }}" alt="user image" class="img-radius profile-img">
                                    </div>
                                </div>
                                <div class="col">
